...
{% image lesson13_ppp-3.jpg fancybox:true %}
...
一种避免不必要的实验的设计方式是，直接向玩家展示他们必须要发现的东西，比如在《传送门》中，按钮和它触发的机关之间一定存在着一条灯带。这样玩家就没有必要亲自站在上面/放个方块在上面看看到底哪个按钮对应着哪个机关。
